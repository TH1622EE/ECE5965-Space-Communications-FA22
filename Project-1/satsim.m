...
sat1 = satellite(sc, "GPS-USA-266-TLE-DATA.tle");
sat2 = satellite(sc, "GPS-USA-289-TLE-DATA.tle");
sat3 = satellite(sc, "GPS-USA-293-TLE-DATA.tle");
sat4 = satellite(sc, "GPS-USA-304-TLE-DATA.tle");
sat5 = satellite(sc, "GPS-USA-309-TLE-DATA.tle");
sat6 = satellite(sc, "GPS-USA-319-TLE-DATA.tle");
